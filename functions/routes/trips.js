...
router.get('/all_trips', async function (req, res) {
  ...
  // Trip list with  trip lider information
  /* On the trip CSV 
  -please add: number of broadcasts,done
  -number of chaperone group chats 
  -number of other chat messages. :done
  You will have to integrate Firebase for these columns)  Also 
  -number of itinerary entries,: done
  - duration of trip in days, :done
  -number of student and number of teacher */ 
  try {
